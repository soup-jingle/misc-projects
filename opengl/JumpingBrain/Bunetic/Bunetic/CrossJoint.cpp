...
// [PB]
// Sphere scale factors mutators
void CrossJoint::setSphereScaleX(float scale)
{
	if (scale > 0.0)
		SphereScaleX = scale;
}

void CrossJoint::setSphereScaleY(float scale)
{
	if (scale > 0.0)
		SphereScaleY = scale;
}

void CrossJoint::setSphereScaleZ(float scale)
{
	if (scale > 0.0)
		SphereScaleZ = scale;
}