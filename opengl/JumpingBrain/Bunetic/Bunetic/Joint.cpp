...
void Joint::draw(GLUquadricObj *qObj)
{
	...
	glScalef(SphereScaleX, SphereScaleY, SphereScaleZ); // Scale sphere appropriately
...
void Joint::setSphereScaleX(float scale)
{
	if(scale > 0.0)	
		SphereScaleX = scale;	
}

void Joint::setSphereScaleY(float scale)
{
	if (scale > 0.0)
		SphereScaleY = scale;
}

void Joint::setSphereScaleZ(float scale)
{
	if (scale > 0.0)
		SphereScaleZ = scale;
}